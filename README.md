...
- สถานะ "รีวิวแล้ว" ของแบบสอบถามหลังกดเสร็จสิ้น — เก็บใน `user_metadata.reviewed` ของ Supabase Auth (ไม่ต้องมีตารางแยก) จึงตามผู้ใช้ข้ามเครื่องได้ ส่วน guest จะเก็บไว้ใน localStorage ของเครื่องนั้นเท่านั้น
